    ...
    <main className="min-h-screen flex flex-col items-center justify-center p-6 md:p-24 relative selection:bg-cyber-cyan selection:text-black">
      ...
      <section className="w-full max-w-5xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Card 1 */}
          <a href="https://www.hoa-hub.cloud/" target="_blank" rel="noopener noreferrer" className="group border border-cyber-cyan ring-1 ring-cyber-cyan/40 ring-offset-2 ring-offset-black bg-black/50 p-6 rounded hover:ring-2 hover:ring-cyber-cyan hover:shadow-[0_0_28px_rgba(0,255,255,0.35)] active:scale-[0.97] transition-all duration-200 block">
          ...
          {/* Card 3 */}
          <a href="https://trainer-notebook-pro.ibislabs.cloud" target="_blank" rel="noopener noreferrer" className="group border border-cyber-cyan ring-1 ring-cyber-cyan/40 ring-offset-2 ring-offset-black bg-black/50 p-6 rounded hover:ring-2 hover:ring-cyber-cyan hover:shadow-[0_0_28px_rgba(0,255,255,0.35)] active:scale-[0.97] transition-all duration-200 block">
            <div className="flex justify-between items-start mb-4">
              <div className="flex items-center gap-3">
